          ...
          <div className="py-14 px-6">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mb-10">
                ...
                <p className="text-slate-500 text-sm">I&apos;m available for freelance work. Response within 24 hours.</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div className="space-y-6">
                  <div className="space-y-4">
                    <a href="mailto:contact@ebenzotoo.com" className="flex items-center gap-4 p-4 bg-white border border-slate-200 rounded-xl hover:border-slate-300 hover:shadow-sm transition-all group">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-700 font-medium">contact@ebenzotoo.com</p>
                      </div>
                    </a>

                    <a href="tel:+233200012873" className="flex items-center gap-4 p-4 bg-white border border-slate-200 rounded-xl hover:border-slate-300 hover:shadow-sm transition-all group">
                      <div className="w-10 h-10 rounded-lg bg-slate-100 flex items-center justify-center shrink-0 group-hover:bg-blue-50 transition-colors">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-700 font-medium">+233 20 001 2873</p>
                      </div>
                    </a>
                    ...
                    <div className="flex items-center gap-4 p-4 bg-white border border-slate-200 rounded-xl">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-700 font-medium">Mile 7, Accra, Ghana</p>
                      </div>
                    </div>
                  </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full bg-slate-900 text-white text-sm font-medium py-2.5 rounded-lg hover:bg-slate-700 disabled:opacity-50 transition-colors flex items-center justify-center gap-2"
                  >
                ...
                <div className="text-os-text-main space-y-3">
                  ...
                  <div className="pl-6 space-y-3">
                    ...
                    <p className="flex items-start gap-3">
                      ...
                      <span className="text-[#ce9178]">&quot;32 Mauve Avenue,<br/>Mile 7, Accra, Ghana&quot;</span>
                    </p>
                  </div>
                  <p>{'};'}</p>
                </div>
